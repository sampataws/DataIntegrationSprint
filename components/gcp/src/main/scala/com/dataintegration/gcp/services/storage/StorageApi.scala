...
import com.dataintegration.gcp.services.storage.application.{DeleteFiles, MoveFiles}
import com.google.cloud.storage.Storage
import zio.{Task, ULayer, ZLayer}

class StorageApi extends ServiceLayerV2[FileStoreConfig, Storage]{
  ...
  override def onCreate(client: Storage, properties: Properties)(data: FileStoreConfig): Task[FileStoreConfig] =
    MoveFiles(client, data, properties).execute
