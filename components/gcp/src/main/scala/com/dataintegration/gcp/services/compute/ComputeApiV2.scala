...
import com.dataintegration.gcp.services.compute.applicationv2.cluster.{CreateCluster, DeleteCluster}
import com.google.cloud.dataproc.v1.ClusterControllerClient
import zio.{Task, ULayer, ZLayer}

class ComputeApiV2 extends ServiceLayerV2[ComputeConfig, ClusterControllerClient] {
